...
class StoreInvoiceRequest extends FormRequest
{
    ...
    {
        return Gate::allows('create invoices');
    }
    ...
    public function messages()
    {
        return [
            ...
            'invoice_number.unique' => 'Nomor pembelian sudah terdaftar.',
            ...
            'invoice_items.*.unit_price.min' => 'Harga satuan produk tidak boleh bernilai negatif.',
            ...
            'invoice_items.*.quantity.min' => 'Kuantitas produk tidak boleh bernilai nol.',   
